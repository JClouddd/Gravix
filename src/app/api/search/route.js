...
const COMMANDS = [
  ...
  { id: "nav-planner", type: "Navigation", label: "Go to Management", icon: "📅", module: "management" },
  ...
  { id: "nav-colab", type: "Navigation", label: "Go to Notebooks", icon: "📊", module: "knowledge" },
  ...
  { id: "act-task", type: "Action", label: "Create Task", icon: "✅", module: "management", desc: "Add a new task to Management" },
  { id: "act-client", type: "Action", label: "Create Client", icon: "➕", module: "clients", desc: "Add a new client profile" },
  { id: "act-notebook", type: "Action", label: "Run Notebook", icon: "▶️", module: "knowledge", desc: "Execute a data notebook" },
